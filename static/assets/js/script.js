...
$(document).ready(function () {
    ...
    console.log("inicio de mensajes socket")
...
$('body').append('' +
    ...
    '<a href="https://www.espoch.edu.ec/" target="_blank" class="btn btn-md btn-primary">' +
    '<i class="fa fa-cogs" aria-hidden="true"></i>ESPOCH | Automatización y Electrónica' +
    '</a> ' +
    '</div>' +
    '');
var $window = $(window);
